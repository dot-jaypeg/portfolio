  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col gap-10 md:flex-row md:items-end md:justify-between">
        <h2 className="font-heading max-w-xl text-4xl font-normal leading-tight md:text-5xl">
          Let's make something{' '}
          <span className="font-alt italic">worth remembering.</span>
        </h2>

        <div className="flex flex-col gap-3 font-heading text-sm font-bold lowercase tracking-wide">
          <a
